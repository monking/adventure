(function() {
  var Adventure, Character, Item, NodeStory, Scene, Story, _ref,
  ...
  NodeStory = (function(_super) {
    __extends(NodeStory, _super);

    function NodeStory() {
      _ref = NodeStory.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    NodeStory.prototype.narrate = function(statement) {
      process.stdin.resume();
      return process.stdout.write("" + statement + "\n");
    };

    NodeStory.prototype.prompt = function(statement) {
      var self;
      self = this;
      this.narrate("" + statement + "\n");
      process.stdout.write(":");
